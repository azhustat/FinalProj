# -*- coding: utf-8 -*-
import sys
sys.path.insert(0, '/Users/angiezhu/Documents/Academics/Berkeley/12_Spring/215B/Project/PythonRelated/sinatpy2.x-(2011-6-8)/sinatpy2.x')
...
import codecs
fp = codecs.open("userdict.txt", "r", "utf-8")
lines = fp.readlines()
# Jeremy Lin's name in simplfied Chinese, UTF8 enconding
name = lines[0].split("@@")[0] 
print name.encode("utf8")

# API only returns 18 or 19 results
s = api.search(name, rpp=30)  
for out in s: print out.text.encode("utf8")

# writes results into a file with UTF8 encoding
try:
